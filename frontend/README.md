...
| Tab | What it does |
|---|---|
| **Model Arena** | Run all 5 models (YOLO, Faster R-CNN, DETR, BLIP, YOLO-seg) on the same image, side by side, with bounding boxes/segmentation masks drawn directly on the image and a latency comparison table |
